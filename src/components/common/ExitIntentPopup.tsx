...
export default function ExitIntentContactModal() {
    ...
    useEffect(() => {
        const handleExit = (e: MouseEvent) => {
            if (e.clientY <= 10) {
                const lastClosed = localStorage.getItem("exit_modal_closed");
    ...
    return (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 p-4">
            ...
            {/* MODAL */}
            <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl bg-white shadow-[0_30px_60px_-30px_rgba(0,0,0,0.35)]">

                {/* CLOSE BUTTON */}
                <button
                    onClick={closeModal}
                    className="absolute right-4 top-4 z-50 text-sm text-slate-500 hover:text-black"
                >
                    ✕
                </button>

                <div className="grid md:grid-cols-[1.1fr_2fr]">
