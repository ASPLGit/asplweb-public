...
//                     <Link href="/">
//                         <Image
//                             src={isScrolled || !isHome  ? "/logo-dark.svg" : "/logo-light.svg"}
//                             alt="Logo"
...
//                             Services
//                             <Image
//                                 src={isScrolled || !isHome ? '/images/icons/chev-down-black.svg' : '/images/icons/chev-down.svg'}
...
//                                 className="flex w-full items-center gap-2 px-3 py-2 rounded text-slate-700 relative z-10 hover:bg-slate-100"
//                             >
//                                 Services
//                                 <Image
...
//                                 className="flex w-full items-center gap-2 px-3 py-2 rounded text-slate-700 hover:bg-slate-100"
//                             >
//                                 Insights
//                                 <Image
//                                     src="/images/icons/chev-down-black.svg"
